...
const AnchoredOverlay = ({
  ...
  focusTrapSettings,
  focusZoneSettings,
  side = (overlayProps === null || overlayProps === undefined ? undefined : overlayProps['anchorSide']) || 'outside-bottom',
  align = 'start',
  alignmentOffset,
  anchorOffset,
  className,
  ...
  const onClickOutside = React.useCallback(() => onClose === null || onClose === undefined ? undefined : onClose('click-outside'), [onClose]);
  const onEscape = React.useCallback(() => onClose === null || onClose === undefined ? undefined : onClose('escape'), [onClose]);
  const onAnchorKeyDown = React.useCallback(event => {
    if (!event.defaultPrevented) {
      if (!open && ['ArrowDown', 'ArrowUp', ' ', 'Enter'].includes(event.key)) {
        onOpen === null || onOpen === undefined ? undefined : onOpen('anchor-key-press', event);
  ...
  const onAnchorClick = React.useCallback(event => {
    ...
    if (!open) {
      onOpen === null || onOpen === undefined ? undefined : onOpen('anchor-click');
    } else {
      onClose === null || onClose === undefined ? undefined : onClose('anchor-click');
    }
  }, [open, onOpen, onClose]);
  const {
    position
  ...
  return /*#__PURE__*/React__default.default.createElement(React__default.default.Fragment, null, renderAnchor && renderAnchor({
    ...
    height: height,
    width: width,
    top: (position === null || position === undefined ? undefined : position.top) || 0,
    left: (position === null || position === undefined ? undefined : position.left) || 0,
    anchorSide: position === null || position === undefined ? undefined : position.anchorSide,
    className: className,
