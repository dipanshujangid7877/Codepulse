...
const Body = toggleStyledComponent.toggleStyledComponent(FeatureFlag.CSS_MODULES_FLAG, 'div', styled__default.default.div.withConfig({
...
const CheckboxOrRadioGroup = ({
  ...
  if (enabled) {
    if (sx) {
      ...
      */
      React__default.default.createElement("legend", {
      ...
      */
      slots.caption), /*#__PURE__*/React__default.default.createElement(Body, _extends({
    ...
    }, /*#__PURE__*/React__default.default.createElement("div", null, /*#__PURE__*/React__default.default.createElement("fieldset", _extends({
      className: clsx.clsx(className, CheckboxOrRadioGroup_module.GroupFieldset),
      "data-validation": validationChild ? '' : undefined
    }, labelChild && {
      as: 'fieldset',
