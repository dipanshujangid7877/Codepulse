...
function useTable({
  ...
  if (columns !== prevColumns) {
    ...
    if (sortByColumn) {
      const column = columns.find(column => {
        var _column$id;
        const id = (_column$id = column.id) !== null && _column$id !== undefined ? _column$id : column.field;
  ...
  const headers = columns.map(column => {
    var _column$id2;
    const id = (_column$id2 = column.id) !== null && _column$id2 !== undefined ? _column$id2 : column.field;
    if (id === undefined) {
        ...
        getCells() {
          return headers.map(header => {
            ...
            return {
              ...
              rowHeader: (_header$column$rowHea = header.column.rowHeader) !== null && _header$column$rowHea !== undefined ? _header$column$rowHea : false,
              getValue() {
                if (header.column.field !== undefined) {
...
function getInitialSortState(columns, initialSortColumn, initialSortDirection) {
  if (initialSortColumn !== undefined) {
    ...
    return {
      ...
      direction: initialSortDirection !== null && initialSortDirection !== undefined ? initialSortDirection : sorting.DEFAULT_SORT_DIRECTION
    };
  }
  if (initialSortDirection !== undefined) {
    ...
    const id = (_column$id3 = column.id) !== null && _column$id3 !== undefined ? _column$id3 : column.field;
    if (id === undefined) {
      if (process.env.NODE_ENV !== "production") {
        // eslint-disable-next-line no-console
...
function getGridTemplateFromColumns(columns) {
  return columns.map(column => {
    var _column$width;
    const columnWidth = (_column$width = column.width) !== null && _column$width !== undefined ? _column$width : 'grow';
    let minWidth = 'auto';
    let maxWidth = '1fr';
    if (columnWidth === 'auto') {
      maxWidth = 'auto';
