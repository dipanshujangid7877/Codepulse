...
var index$1 = require('../node_modules/@github/mini-throttle/dist/index.js');
...
var AutocompleteMenu_module = require('./AutocompleteMenu.module.css.js');
...
function getDefaultItemFilter(filterValue) {
  return function (item, _i) {
    var _item$text;
    return Boolean((_item$text = item.text) === null || _item$text === undefined ? undefined : _item$text.toLowerCase().startsWith(filterValue.toLowerCase()));
  };
}
 ...
 */
const debounceAnnouncement = index$1.debounce(announcement => {
...
function AutocompleteMenu(props) {
  ...
  const selectableItems = React.useMemo(() => items.map(selectableItem => {
    return {
      ...
      active: (highlightedItem === null || highlightedItem === undefined ? undefined : highlightedItem.id) === selectableItem.id,
      ...
      onAction: item => {
        ...
        if (selectionVariant === 'multiple') {
          ...
          setShowMenu(false);
          (_inputRef$current = inputRef.current) === null || _inputRef$current === undefined ? undefined : _inputRef$current.setSelectionRange(inputRef.current.value.length, inputRef.current.value.length);
        }
      }
    };
  ...
  ...(addNewItem ? [{
    ...
    role: 'option',
    key: addNewItem.id,
    active: (highlightedItem === null || highlightedItem === undefined ? undefined : highlightedItem.id) === addNewItem.id,
    ...
    onActiveDescendantChanged: (current, _previous, directlyActivated) => {
      ...
      if (current) {
        const selectedItem = allItemsToRenderRef.current.find(item => {
          ...
          return item.id === ((_current$closest = current.closest('li')) === null || _current$closest === undefined ? undefined : _current$closest.getAttribute('data-id'));
        });
  ...
  React.useEffect(() => {
    ...
    if (highlightedItem !== null && highlightedItem !== undefined && (_highlightedItem$text = highlightedItem.text) !== null && _highlightedItem$text !== undefined && _highlightedItem$text.startsWith(inputValue) && !selectedItemIds.includes(highlightedItem.id)) {
  ...
  return /*#__PURE__*/React__default.default.createElement(_VisuallyHidden, {
    isVisible: showMenu
  }, loading ? enabled ? /*#__PURE__*/React__default.default.createElement(Box, {
    className: AutocompleteMenu_module.SpinnerWrapper
  }, /*#__PURE__*/React__default.default.createElement(Spinner, null)) : /*#__PURE__*/React__default.default.createElement(Box, {
    p: 3,
    display: "flex",
    ...
    return /*#__PURE__*/React__default.default.createElement(index.ActionList.Item, _extends({
      ...
      id: id,
      "data-id": id
    }), LeadingVisual && /*#__PURE__*/React__default.default.createElement(index.ActionList.LeadingVisual, null, reactIs.isElement(LeadingVisual) ? LeadingVisual : /*#__PURE__*/React__default.default.createElement(LeadingVisual, null)), children !== null && children !== undefined ? children : text, TrailingVisual && /*#__PURE__*/React__default.default.createElement(index.ActionList.TrailingVisual, null, reactIs.isElement(TrailingVisual) ? TrailingVisual : /*#__PURE__*/React__default.default.createElement(TrailingVisual, null)));
  })) : emptyStateText !== false && emptyStateText !== null ? enabled ? /*#__PURE__*/React__default.default.createElement(Box, {
    className: AutocompleteMenu_module.EmptyStateWrapper
  }, emptyStateText) : /*#__PURE__*/React__default.default.createElement(Box, {
    p: 3
  }, emptyStateText) : null));
}
