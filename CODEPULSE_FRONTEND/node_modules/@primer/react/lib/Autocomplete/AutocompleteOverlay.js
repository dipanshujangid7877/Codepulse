...
function AutocompleteOverlay({
  ...
  return showMenu ? /*#__PURE__*/React__default.default.createElement(Overlay.default, _extends({
    ...
    top: position === null || position === undefined ? undefined : position.top,
    left: position === null || position === undefined ? undefined : position.left,
    sx: enabled ? undefined : {
      overflow: 'auto'
    },
    className: enabled ? AutocompleteOverlay_module.Overlay : undefined
