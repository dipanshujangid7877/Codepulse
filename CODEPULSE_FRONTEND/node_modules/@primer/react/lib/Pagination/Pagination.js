  ...
  const children = React__default.default.useMemo(() => {
    return model$1.map(page => {
      ...
      return /*#__PURE__*/React__default.default.createElement(Page, _extends({}, props, {
        key: key,
        theme: theme,
        className: clsx.clsx(enabled && Pagination_module.Page)
      }), content);
    });
  }, [model$1, hrefBuilder, pageChange, theme, enabled]);
  return children;
}
const PaginationContainer = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'nav', styled__default.default.nav.withConfig({
...
function Pagination({
  ...
  return /*#__PURE__*/React__default.default.createElement(PaginationContainer, _extends({
    className: clsx.clsx(enabled && Pagination_module.PaginationContainer),
