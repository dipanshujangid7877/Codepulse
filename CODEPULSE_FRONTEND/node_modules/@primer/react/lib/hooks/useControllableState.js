...
function useControllableState({
  ...
  const [state, internalSetState] = React__default.default.useState(value !== null && value !== undefined ? value : defaultValue);
  ...
  const setState = React__default.default.useCallback(stateOrUpdater => {
    ...
    (_stableOnChange$curre = stableOnChange.current) === null || _stableOnChange$curre === undefined ? undefined : _stableOnChange$curre.call(stableOnChange, value);
  }, [state]);
  React__default.default.useEffect(() => {
