...
function getBreakpointDeclarations(value, cssProperty, mapFn) {
  if (useResponsiveValue.isResponsiveValue(value)) {
...
exports.areAllValuesTheSame = areAllValuesTheSame;
exports.getBreakpointDeclarations = getBreakpointDeclarations;
exports.haveRegularAndWideSameValue = haveRegularAndWideSameValue;
