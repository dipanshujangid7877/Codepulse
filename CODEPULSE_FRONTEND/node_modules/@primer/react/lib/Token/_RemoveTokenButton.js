...
var _RemoveTokenButton_module = require('./_RemoveTokenButton.module.css.js');
...
const StyledTokenButton = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'span', styled__default.default.span.withConfig({
...
const RemoveTokenButton = ({
  ...
  return /*#__PURE__*/React__default.default.createElement(StyledTokenButton, _extends({
    ...
    size: size,
    "data-size": size,
    className: clsx.clsx(enabled && _RemoveTokenButton_module.TokenButton, className),
    style: enabled ? {
