...
var IssueLabelToken_module = require('./IssueLabelToken.module.css.js');
...
const IssueLabelToken = /*#__PURE__*/React.forwardRef((props, forwardedRef) => {
  ...
  const labelStyles = React.useMemo(() => {
    ...
    const isLightScheme = !(resolvedColorScheme !== null && resolvedColorScheme !== undefined && resolvedColorScheme.startsWith('dark')); // fall back to light colors for unknown schemes
  ...
  if (enabled) {
    return /*#__PURE__*/React__default.default.createElement(TokenBase.default, _extends({
      ...
      className: clsx.clsx(IssueLabelToken_module.IssueLabel, className),
      text: text,
      size: size,
      style: labelStyles,
      ...
      className: IssueLabelToken_module.RemoveButton
    }) : null);
  }
  return /*#__PURE__*/React__default.default.createElement(TokenBase.default, _extends({
    onRemove: onRemove,
...
module.exports = IssueLabelToken;
