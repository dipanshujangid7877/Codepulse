...
const List = /*#__PURE__*/React__default.default.forwardRef(({
  ...
  const ariaLabelledBy = slots.heading ? (_slots$heading$props$ = slots.heading.props.id) !== null && _slots$heading$props$ !== undefined ? _slots$heading$props$ : headingId : listLabelledBy;
  const listRole = role || listRoleFromContainer;
  const listRef = useProvidedRefOrCreate.useProvidedRefOrCreate(forwardedRef);
  let enableFocusZone = false;
  if (enableFocusZoneFromContainer !== undefined) enableFocusZone = enableFocusZoneFromContainer;else if (listRole) enableFocusZone = ['menu', 'menubar', 'listbox'].includes(listRole);
  ...
  return /*#__PURE__*/React__default.default.createElement(shared.ListContext.Provider, {
  ...
  }, slots.heading, enabled ? sxProp !== defaultSxProp.defaultSxProp ? /*#__PURE__*/React__default.default.createElement(ListBox, _extends({
  ...
  }, props), childrenWithoutSlots) : /*#__PURE__*/React__default.default.createElement("ul", _extends({
    className: clsx.clsx(ActionList_module.ActionList, className),
    role: listRole,
    "aria-labelledby": ariaLabelledBy,
    ref: listRef,
    "data-dividers": showDividers,
    "data-variant": variant
  }, props), childrenWithoutSlots) : /*#__PURE__*/React__default.default.createElement(ListBox, _extends({
    sx: merge__default.default(styles, sxProp),
    role: listRole,
    "aria-labelledby": ariaLabelledBy
  }, props, {
