...
declare function Stack<As extends ElementType>({ as, children, align, direction, gap, justify, padding, wrap, className, ...rest }: StackProps<As> & React.ComponentPropsWithoutRef<ElementType extends As ? As : 'div'>): React.JSX.Element;
...
declare function StackItem<As extends ElementType>({ as, children, grow, className, ...rest }: StackItemProps<As> & React.ComponentPropsWithoutRef<ElementType extends As ? As : 'div'>): React.JSX.Element;
