...
const StyledStack = toggleStyledComponent.toggleStyledComponent(CSS_MODULE_FEATURE_FLAG, 'div', styled__default.default.div.withConfig({
...
function Stack({
  ...
  const BaseComponent = as !== null && as !== undefined ? as : 'div';
...
const StyledStackItem = toggleStyledComponent.toggleStyledComponent(CSS_MODULE_FEATURE_FLAG, 'div', styled__default.default.div.withConfig({
...
function StackItem({
  ...
  return /*#__PURE__*/React__default.default.createElement(StyledStackItem, _extends({}, rest, {
    as: BaseComponent,
    className: clsx.clsx(className, {
      [Stack_module.StackItem]: enabled
    })
