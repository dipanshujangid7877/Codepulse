...
declare function Blankslate({ border, children, narrow, spacious, className }: BlankslateProps): React.JSX.Element;
...
declare function Heading({ as: Component, children }: HeadingProps): React.JSX.Element;
...
declare function PrimaryAction({ children, href, ...props }: PrimaryActionProps): React.JSX.Element;
