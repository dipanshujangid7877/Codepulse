...
var ActionBar_module = require('./ActionBar.module.css.js');
...
const ActionBar = props => {
  ...
  return /*#__PURE__*/React__default.default.createElement(ActionBarContext.Provider, {
    ...
    ref: navRef,
    className: clsx.clsx(className, ActionBar_module.Nav),
    "data-flush": flush
  }, /*#__PURE__*/React__default.default.createElement("div", {
    ref: listRef,
    role: "toolbar",
    className: ActionBar_module.List
...
const ActionBarIconButton = /*#__PURE__*/React.forwardRef((props, forwardedRef) => {
  ...
  const ref = forwardedRef !== null && forwardedRef !== undefined ? forwardedRef : backupRef;
  const {
    size,
    setChildrenWidth
...
const VerticalDivider = () => {
  ...
  return /*#__PURE__*/React__default.default.createElement("div", {
    ...
    "aria-hidden": "true",
    className: ActionBar_module.Divider
  });
};
