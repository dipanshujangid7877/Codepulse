...
const StyledItem = styled__default.default.div.withConfig({
  ...
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).color, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).hoverBg, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).hoverText, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).hoverCursor, Divider.StyledDivider, Header.StyledHeader, ({
  showDivider
  ...
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).focusBg, behaviors.isActiveDescendantAttribute, behaviors.activeDescendantActivatedIndirectly, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).hoverBg, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).focusBg, ({
  variant,
  item
}) => getItemVariant(variant, item === null || item === undefined ? undefined : item.disabled).focusBg, sx.default);
...
const Item = /*#__PURE__*/React__default.default.forwardRef((itemProps, ref) => {
  ...
  const keyPressHandler = React.useCallback(event => {
    ...
    onKeyPress === null || onKeyPress === undefined ? undefined : onKeyPress(event);
    if (!event.defaultPrevented && [' ', 'Enter'].includes(event.key)) {
      onAction === null || onAction === undefined ? undefined : onAction(itemProps, event);
    }
  ...
  return /*#__PURE__*/React__default.default.createElement(StyledItem, _extends({
    ...
    fill: theme === null || theme === undefined ? undefined : theme.colors.fg.default
    ...
    variant: variant,
    disabled: disabled
  }, typeof TrailingVisual !== 'string' && reactIs.isValidElementType(TrailingVisual) ? /*#__PURE__*/React__default.default.createElement(TrailingVisual, null) : TrailingVisual) : TrailingIcon || trailingText ? /*#__PURE__*/React__default.default.createElement(TrailingContent, {
    variant: variant,
    disabled: disabled
