...
var getSegmentedControlStyles$1 = require('./getSegmentedControlStyles.js');
...
const SegmentedControlList = toggleStyledComponent.toggleStyledComponent(getSegmentedControlStyles$1.SEGMENTED_CONTROL_CSS_MODULES_FEATURE_FLAG, 'ul', styled__default.default.ul.withConfig({
...
const Root = ({
  ...
  const getChildIcon = childArg => {
    if (/*#__PURE__*/React__default.default.isValidElement(childArg) && childArg.type === SegmentedControlButton && childArg.props.leadingIcon) {
      if (reactIs.isElement(childArg.props.leadingIcon)) {
        ...
        return /*#__PURE__*/React__default.default.createElement(LeadingIcon, null);
      }
    }
  ...
  const enabled = useFeatureFlag.useFeatureFlag(getSegmentedControlStyles$1.SEGMENTED_CONTROL_CSS_MODULES_FEATURE_FLAG);
  const listSx = enabled ? sxProp : merge__default.default(getSegmentedControlStyles({
    isFullWidth,
    size
  }), sxProp);
  ...
  React__default.default.createElement(React__default.default.Fragment, null, /*#__PURE__*/React__default.default.createElement(ActionMenu.ActionMenu, null, /*#__PURE__*/React__default.default.createElement(ActionMenu.ActionMenu.Button, {
    "aria-label": ariaLabel && `${getChildText(selectedChild)}, ${ariaLabel}`,
    leadingVisual: getChildIcon(selectedChild)
  }, getChildText(selectedChild)), /*#__PURE__*/React__default.default.createElement(ActionMenu.ActionMenu.Overlay, {
    "aria-labelledby": ariaLabelledby
  ...
  React__default.default.createElement(SegmentedControlList, _extends({
    ...
    className: clsx.clsx(enabled && SegmentedControl_module.SegmentedControl, className),
    ...
    const sharedChildProps = {
      ...
      sx: {
        '--separator-color': index === selectedIndex || index === selectedIndex - 1 ? 'transparent' : theme === null || theme === undefined ? undefined : theme.colors.border.default,
        ...child.props.sx
      }
    };
    ...
    if (responsiveVariant === 'hideLabels' && /*#__PURE__*/React__default.default.isValidElement(child) && child.type === SegmentedControlButton) {
      ...
      if (!leadingIcon) {
        ...
        return /*#__PURE__*/React__default.default.createElement(SegmentedControlIconButton.SegmentedControlIconButton, _extends({
