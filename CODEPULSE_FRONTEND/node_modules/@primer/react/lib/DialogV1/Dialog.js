...
// Dialog v1
const noop = () => null;
const DialogBase = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'div', styled__default.default.div.withConfig({
  displayName: "Dialog__DialogBase",
  componentId: "sc-1y662gy-0"
...
const DialogHeaderBase = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'div', styled__default.default(Box).withConfig({
  displayName: "Dialog__DialogHeaderBase",
  componentId: "sc-1y662gy-1"
...
function DialogHeader({
  ...
  return /*#__PURE__*/React__default.default.createElement(DialogHeaderBase, _extends({
    ...
    className: enabled ? Dialog_module.Header : undefined
  }), children);
}
DialogHeader.displayName = "DialogHeader";
const Overlay = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'span', styled__default.default.span.withConfig({
  displayName: "Dialog__Overlay",
  componentId: "sc-1y662gy-2"
...
const Dialog = /*#__PURE__*/React.forwardRef(({
  ...
  return isOpen ? /*#__PURE__*/React__default.default.createElement(React__default.default.Fragment, null, /*#__PURE__*/React__default.default.createElement(Overlay, {
    className: enabled ? Dialog_module.Overlay : undefined,
    ref: overlayRef
