...
var ConfirmationDialog_module = require('./ConfirmationDialog.module.css.js');
...
const StyledConfirmationHeader = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'div', styled__default.default.div.withConfig({
...
const StyledTitle = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'h1', styled__default.default(Box).attrs({
  as: 'h1'
}).withConfig({
...
const ConfirmationHeader = ({
  ...
  return /*#__PURE__*/React__default.default.createElement(StyledConfirmationHeader, {
    className: enabled && ConfirmationDialog_module.ConfirmationHeader
...
const StyledConfirmationBody = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'div', styled__default.default(Box).withConfig({
  displayName: "ConfirmationDialog__StyledConfirmationBody",
  componentId: "sc-11fz0jh-2"
})(["font-size:", ";padding:0 ", " ", " ", ";flex-grow:1;"], constants.get('fontSizes.1'), constants.get('space.3'), constants.get('space.3'), constants.get('space.3')));
const ConfirmationBody = ({
  children
}) => {
  const enabled = useFeatureFlag.useFeatureFlag(CSS_MODULES_FEATURE_FLAG);
  return /*#__PURE__*/React__default.default.createElement(StyledConfirmationBody, {
    className: enabled && ConfirmationDialog_module.ConfirmationBody
  }, children);
};
ConfirmationBody.displayName = "ConfirmationBody";
const StyledConfirmationFooter = toggleStyledComponent.toggleStyledComponent(CSS_MODULES_FEATURE_FLAG, 'div', styled__default.default(Box).withConfig({
...
const ConfirmationFooter = ({
  ...
  return /*#__PURE__*/React__default.default.createElement(StyledConfirmationFooter, {
    ref: footerRef,
    className: enabled && ConfirmationDialog_module.ConfirmationFooter
  }, /*#__PURE__*/React__default.default.createElement(Dialog.Dialog.Buttons, {
    buttons: footerButtons !== null && footerButtons !== undefined ? footerButtons : []
  }));
};
