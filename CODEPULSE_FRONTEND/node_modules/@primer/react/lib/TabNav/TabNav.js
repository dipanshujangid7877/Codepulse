...
function TabNav({
  ...
  const customStrategy = React__default.default.useCallback(() => {
    ...
    const selectedTab = (_customContainerRef$c = customContainerRef.current) === null || _customContainerRef$c === undefined ? undefined : _customContainerRef$c.querySelector('[role=tab][aria-selected=true]');
    const firstTab = (_customContainerRef$c2 = customContainerRef.current) === null || _customContainerRef$c2 === undefined ? undefined : _customContainerRef$c2.querySelector('[role=tab]');
    return (_ref = selectedTab !== null && selectedTab !== undefined ? selectedTab : firstTab) !== null && _ref !== undefined ? _ref : undefined;
  }, [customContainerRef]);
  const {
    containerRef: navRef
...
const TabNavLink = styled__default.default.a.attrs(props => ({
  className: clsx.clsx(ITEM_CLASS, props.selected && SELECTED_CLASS, props.className),
  role: 'tab',
...
})(["padding:8px 12px;font-size:", ";line-height:20px;color:", ";text-decoration:none;background-color:transparent;border:1px solid transparent;border-bottom:0;", ";&:hover,&:focus{color:", ";text-decoration:none;}&.selected{color:", ";border-color:", ";border-top-right-radius:", ";border-top-left-radius:", ";background-color:", ";}", ";"], constants.get('fontSizes.1'), constants.get('colors.fg.default'), getGlobalFocusStyles('-6px'), constants.get('colors.fg.default'), constants.get('colors.fg.default'), constants.get('colors.border.default'), constants.get('radii.2'), constants.get('radii.2'), constants.get('colors.canvas.default'), sx.default);
