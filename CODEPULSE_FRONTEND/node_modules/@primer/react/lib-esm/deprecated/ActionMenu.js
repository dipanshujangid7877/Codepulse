...
const ActionMenuBase = ({
  anchorContent,
  renderAnchor = props => /*#__PURE__*/React.createElement(ButtonComponent, props),
    ...
    return items.map(item => {
      return {
        ...
        onAction: (props, event) => {
          var _item$onAction;
          const actionCallback = (_item$onAction = item.onAction) !== null && _item$onAction !== undefined ? _item$onAction : onAction;
          actionCallback === null || actionCallback === undefined ? undefined : actionCallback(props, event);
