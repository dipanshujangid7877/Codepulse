...
type BranchNameProps<As extends React.ElementType> = {
    as?: As;
} & DistributiveOmit<React.ComponentPropsWithRef<React.ElementType extends As ? 'a' : As>, 'as'> & SxProp;
...
declare const _default: <As extends React.ElementType>(props: {
    as?: As | undefined;
} & DistributiveOmit<React.ComponentPropsWithRef<React.ElementType<any, keyof React.JSX.IntrinsicElements> extends As ? "a" : As>, "as"> & SxProp & React.RefAttributes<any>) => React.ReactNode;
